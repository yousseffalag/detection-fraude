...
model = Pipeline(steps=[
    ...
    ("classifier", LogisticRegression(
        C=10,              # force le paramètre de régularisation
        penalty='l2',      # penalty doit être une string
        random_state=42,   # pour reproductibilité
        solver='lbfgs',    # solver compatible avec l2
        max_iter=1000      # optionnel : augmenter si convergence lente
    ))
])
...
joblib.dump(model, "ml_models_1/LR_Pipeline_new.pkl")
print("✅ Modèle sauvegardé : ml_models_1/fraud_model_LR.pkl")
